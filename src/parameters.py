#%%
import os
MODEL_EVAL= "01-17-12:44" #"01-15-15:05"
NUM_LAYER=2
NUM_EPOCH=100
...
pretrain_model= "01-17-12:44" #"01-15-11:38" #"01-13-15:56" #"01-12-09:50" #"01-11-18:19"
...
if VAL_ORIGINAL:
    DATA_TEST= os.path.join(DATA_TEST_DIR,"couples_N_8_small.h5")
else:
